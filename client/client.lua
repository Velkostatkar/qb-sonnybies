...
AddEventHandler('QBCore:Client:OnPlayerLoaded', function(xPlayer)
	...
	players = {}
		...
		RegisterNetEvent("qb-sonnybies:playerupdate")
		AddEventHandler("qb-sonnybies:playerupdate", function(mPlayers)
			players = mPlayers
		end)
	...
	entitys = {}
		...
		TriggerServerEvent("qb-sonnybies:newplayer", PlayerId())
